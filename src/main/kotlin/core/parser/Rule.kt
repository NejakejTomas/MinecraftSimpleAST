 ...
 */
abstract class Rule<T : Node, S>(val matcher: Matcher) {
  ...
  abstract fun parse(matcher: Matcher, parser: Parser<in T, S>, state: S): ParseSpec<T, S>
   ...
   */
  abstract class BlockRule<T : Node, S>(pattern: Pattern) : Rule<T, S>(pattern) {
